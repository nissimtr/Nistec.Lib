...
namespace Nistec
{
    ...
    public class Id64Generator : IIdGenerator<long>
    {
        ...
        internal Id64Generator(string source)
        {

            int workerId= NetConfig.AppSettings.Get<int>("generator_Id");
            int datacenterId = NetConfig.AppSettings.Get<int>("generator_datacenterId");
            int sequence = NetConfig.AppSettings.Get<int>("generator_sequence");

            //int workerId, int datacenterId, int sequence = 0
        ...
        public static readonly Id64Generator GenId = new Id64Generator("config");

        public static long NewId()
        {
            return GenId.GenerateId();
        }
        public static string NewSId()
        {
            return BaseConverter.ToBase32(NewId().ToString());
        }
        public static IEnumerable<long> Take(int count)
        {
            return GenId.Take(count);
        }
        public static IEnumerator<long> Enumerator()
        {
            return GenId.GetEnumerator();
        }
